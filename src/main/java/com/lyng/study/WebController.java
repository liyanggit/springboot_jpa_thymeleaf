...
//        return bookMap;
    ...
    /**
     * 获取全部书单
     *  @PageableDefault 注解可以将Pageable类中的非法参数值过滤,避免对方法的恶意损害
     *  其中 page默认为0;size默认为10;sort代表排序字段,是一个字符串数组
     * @return
     */
    @GetMapping("/books")
    //public String getBooks(Model model,@RequestParam(defaultValue = "0") int page,@RequestParam(defaultValue = "3") int size) {
    public String getBooks(Model model,@PageableDefault(size = 3,
        ...
        //Page<Book> pages = bookService.getBooksByPage(pageable);
